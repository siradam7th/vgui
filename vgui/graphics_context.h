...
namespace vgui
{
    ...
    public:
        ...
        virtual void fillText(const std::string& text, float font_size, const std::string& font_name, vec2f pos, vec4f color, FontStyle font_style) = 0;
        virtual vec4f calcTextBounds(const std::string& text, float font_size, const std::string& font_name) = 0;
